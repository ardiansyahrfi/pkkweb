    ...
    <div class="container p-3">
        <div class="row justify-content-center">
            <div class="col-lg-8 mx-auto mt-5">
                <div class="pb-4">
                    <div class="section shadow bg-gradient p-3 miliyan-rounded-sedang">
                        <div class="card-header ">
                            <h2><strong>Terms and Conditions</strong></h2>
                            <hr>
                            <div class="card-body ">
                                <div class="card-body">
                                    <p>Welcome to gamcukstore.my.id!</p>

                                    <p>These terms and conditions outline the rules and regulations for the use of
                                        gamcukstore.my.id's Website, located at https://gamcukstore.my.id.</p>

                                    <p>By accessing this website we assume you accept these terms and conditions. Do not
                                        continue to use gamcukstore.my.id if you do not agree to take all of the terms and
                                    ...
                                    <p>We employ the use of cookies. By accessing gamcukstore.my.id, you agreed to use cookies in
                                        agreement with the gamcukstore.my.id's Privacy Policy. </p>
                                    ...
                                    <p>Unless otherwise stated, gamcukstore.my.id and/or its licensors own the intellectual
                                        property rights for all material on gamcukstore.my.id. All intellectual property rights
                                        are reserved. You may access this from gamcukstore.my.id for your own personal use
                                        subjected to restrictions set in these terms and conditions.</p>

                                    <p>You must not:</p>
                                    <ul>
                                        <li>Republish material from gamcukstore.my.id</li>
                                        <li>Sell, rent or sub-license material from gamcukstore.my.id</li>
                                        <li>Reproduce, duplicate or copy material from gamcukstore.my.id</li>
                                        <li>Redistribute content from gamcukstore.my.id</li>
                                    </ul>

                                    <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were
                                        created with the help of the <a
                                            href="https://www.termsandconditionsgenerator.com/">Free Terms and
                                            Conditions Generator</a>.</p>

                                    <p>Parts of this website offer an opportunity for users to post and exchange
                                        opinions and information in certain areas of the website. gamcukstore.my.id does not
                                        filter, edit, publish or review Comments prior to their presence on the website.
                                        Comments do not reflect the views and opinions of gamcukstore.my.id,its agents and/or
                                        affiliates. Comments reflect the views and opinions of the person who post their
                                        views and opinions. To the extent permitted by applicable laws, gamcukstore.my.id shall
                                    ...
                                    <p>gamcukstore.my.id reserves the right to monitor all Comments and to remove any Comments
                                    ...
                                    <p>You hereby grant gamcukstore.my.id a non-exclusive license to use, reproduce, edit and
                                    ...
                                    <p>We will approve link requests from these organizations if we decide that: (a) the
                                        ...
                                        of gamcukstore.my.id; and (d) the link is in the context of general resource information.
                                    </p>
                                    ...
                                    <p>If you are one of the organizations listed in paragraph 2 above and are
                                        ...
                                        gamcukstore.my.id. Please include your name, your organization name, contact information
                                    ...
                                    <p>No use of gamcukstore.my.id's logo or other artwork will be allowed for linking absent a
