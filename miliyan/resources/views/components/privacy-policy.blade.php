                ...
                <div class="pb-4">
                    <div class="section shadow bg-gradient p-3 miliyan-rounded-sedang">
                        <div class="card-header ">
                            <h1>Privacy Policy for fannstore</h1>
                            <hr>
                            <div class="card-body ">
                                <div class="card-body">

                                    <p>At miliyan.id, accessible from https://fannstore.xyz, one of our main priorities
                                        is the privacy of our visitors. This Privacy Policy document contains types of
                                        information that is collected and recorded by miliyan.id and how we use it.</p>
                                    ...
                                    <p>miliyan.id follows a standard procedure of using log files. These files log
                                    ...
                                    <p>Like any other website, miliyan.id uses 'cookies'. These cookies are used to store
                                    ...
                                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript,
                                        ...
                                        appear on miliyan.id, which are sent directly to users' browser. They
                                    ...
                                    <p>Note that fannstore has no access to or control over these cookies that are used
                                        by third-party advertisers.</p>

                                    <h2>Third Party Privacy Policies</h2>

                                    <p>fannstore's Privacy Policy does not apply to other advertisers or websites. Thus,
                                    ...
                                    <p>miliyan.id does not knowingly collect any Personal Identifiable Information from
                                    ...
                                    <p>This Privacy Policy applies only to our online activities and is valid for
                                        ...
                                        collect in miliyan.id. This policy is not applicable to any information collected
