        ...
        <div class="col-lg-6 mx-auto mt-5">
            <div class="pb-4 ">
                <div class="text-center mb-3">
                    <img src="{{ isset($logofooter->path) ? $logofooter->path : "" }}" class="mlImg" alt="bosstore" width="150" height="150">
                </div>
                <div class="section">
                            ...
                            <div class="card-body">
                                <form class="mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <a class="btn btn-primary d-block w-100" href="https://bosstore.my.id/game/mobile-legends">Top up</a>
                                        </div>
                                    </div>
                                </form>
